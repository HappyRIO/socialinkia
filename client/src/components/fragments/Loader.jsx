...
//   return (
//     <div className="w-full h-screen fixed flex justify-center items-center bg-[rgba(0,0,0,0.71)]">
...
// export default function Loader() {
//   return (
//     <div className="fixed inset-0 flex justify-center items-center bg-[rgba(0,0,0,0.71)]">
