...
export default function PostContainer({ data }) {
  ...
  // post status identifyer
  const textColor =
    data.status === "failed"
      ? setPostContent(
          "please kindly reconnect your social media account, if this continues report to use"
        )
      : data.status === "published"
      ? "text-green-500"
      : "text-black"; // Default color for scheduled or other statuses
